...
# The issue is that dlt.apply_changes() is deprecated and not supported in Lakeflow Declarative Pipelines.
# Replace it with dlt.create_auto_cdc_flow() for change data capture.
